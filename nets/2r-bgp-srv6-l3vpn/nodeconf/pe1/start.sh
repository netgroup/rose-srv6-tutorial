...
$FRR_PATH/staticd -f "$PWD"/$BASE_DIR/$NODE_NAME/staticd.conf -d -z "$PWD"/$BASE_DIR/$NODE_NAME/zebra.sock -i "$PWD"/$BASE_DIR/$NODE_NAME/staticd.pid

$FRR_PATH/bgpd -f "$PWD"/$BASE_DIR/$NODE_NAME/bgpd.conf -d -z "$PWD"/$BASE_DIR/$NODE_NAME/zebra.sock -i "$PWD"/$BASE_DIR/$NODE_NAME/bgpd.pid
